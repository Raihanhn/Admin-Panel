...
import img1 from '../../assets/user3.jpg'
import img2 from '../../assets/m1.jpg'
import img3 from '../../assets/m2.jpg'
import img4 from '../../assets/m3.jpg'
import img5 from '../../assets/k1.jpg'
      ...
      <div className="heading flex">
       ...
       <div className="secContainer flex">
        ...
        <div className="singleItem">
          ...
          <img src={imgb} alt="Image Name" />
          <h3>Coffee Plant</h3>
        </div>

        <div className="singleItem">
          <AiFillHeart className='icon' />
          <img src={imgf} alt="Image Name" />
          <h3>Button Fern</h3>
        </div>

        <div className="singleItem">
          <AiOutlineHeart className='icon' />
          <img src={imgd} alt="Image Name" />
          <h3>Spider Plant</h3>
        </div>
